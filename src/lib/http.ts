...
const request = async <Response>(
  ...
  // Interceptor là nơi xử lý request và response trước khi trả về cho phía component
  if (!res.ok) {
      ...
      if (isClient()) {
        if (!clientLogoutRequest) {
          ...
          try {
            ...
            // Vì nếu rơi vào trường hợp mà tại trang login có gọi api gì đó yêu cầu authentication
